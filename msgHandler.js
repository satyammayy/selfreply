...
module.exports = msgHandler = async (client, message) => {
	...
	if (isGroupMsg && isRule && (type === 'chat' && message.body.includes('chat.whatsapp.com') && isBotGroupAdmins) && !isGroupAdmins) return await client.removeParticipant(chat.id, author)
        ...
        switch (command) {
            case 'sticker':
			case 'st':
					let metadata = { author: "💞🐲𝐵𝒾𝓃𝒶💝𝕽𝖆𝖏𝖊𝖓🐉💞", pack: "*⋆  🎀 𝖇𝖔𝖙🎀  ⋆*" };
	   ...
	   case 'stcmeme':
		if (!q.includes('|')) return await client.reply(from, 'Incorrect format, Baka', id)
                if (isMedia && type === "image" || quotedMsg && quotedMsg.type === "image") {
                    ...
                    await client.sendStickerfromUrl(from, create, null, { author: '💞🐲𝐵𝒾𝓃𝒶💝𝕽𝖆𝖏𝖊𝖓🐉💞', pack: '*⋆  🎀 𝖇𝖔𝖙🎀  ⋆*', keepScale: true });
                } else {
        ...
        case 'doge':
                fun.doge()
                    .then(async (body) => {
                        ...
                        await client.sendStickerfromUrl(from, dogegx, null, { author: '💞🐲𝐵𝒾𝓃𝒶💝𝕽𝖆𝖏𝖊𝖓🐉💞', pack: '*⋆  🎀 𝖇𝖔𝖙🎀  ⋆*' })
                    })
                    .catch(async (err) => {
                        console.error(err)
        ...
        case 'wh':
                fun.wholesome()
                    .then(async (body) => {
                        ...
                        await client.sendStickerfromUrl(from, wholesomegx, null, { author: '💞🐲𝐵𝒾𝓃𝒶💝𝕽𝖆𝖏𝖊𝖓🐉💞', pack: '*⋆  🎀 𝖇𝖔𝖙🎀  ⋆*' })
                    })
                    .catch(async (err) => {
                        console.error(err)
                        await client.reply(from, 'Gomen nasai Senpai, something went wrong!!', id)
        ...
        case 'astick':
                fun.animestick()
                    .then(async (body) => {
                        ...
                        await client.sendStickerfromUrl(from, animestickgx, null, { author: '💞🐲𝐵𝒾𝓃𝒶💝𝕽𝖆𝖏𝖊𝖓🐉💞', pack: '*⋆  🎀 𝖇𝖔𝖙🎀  ⋆*' })
                    })
                    .catch(async (err) => {
                        console.error(err)
                        await client.reply(from, 'Gomen nasai Senpai, something went wrong!!', id)
...
${desc}`)
        ...
        case 'bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) client.sendText(ids, `[ 💞🐲𝐵𝒾𝓃𝒶💝𝕽𝖆𝖏𝖊𝖓🐉💞 BOT Broadcast ]\n\n${msg}`)
            }
...
*Link*: ${url}`
		...
		case 'slap':
			client.sendStickerfromUrl(from, (await neko.sfw.slap()).url, null, { author: '💞🐲𝐵𝒾𝓃𝒶💝𝕽𝖆𝖏𝖊𝖓🐉💞', pack: '*⋆  🎀 𝖇𝖔𝖙🎀  ⋆*', keepScale: true });
